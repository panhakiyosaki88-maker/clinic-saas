...
export const NAV: NavItem[] = [
  ...
  { key: "imaging", label: "Imaging", href: "/imaging", icon: ScanLine, permission: PERMISSIONS.IMAGING_READ },
  { key: "procedures", label: "Procedures", href: "/procedures", icon: Syringe, permission: PERMISSIONS.PROCEDURES_READ },
  ...
  { key: "notifications", label: "Notifications", href: "/notifications", icon: Bell, permission: PERMISSIONS.NOTIFICATIONS_READ },
  {
    ...
    href: "/settings",
    icon: Settings,
    permission: [PERMISSIONS.CLINIC_MANAGE, PERMISSIONS.STAFF_MANAGE, PERMISSIONS.SUBSCRIPTION_MANAGE, PERMISSIONS.BILLING_READ],
  },
];
