...
import { deleteMedicine } from "@/server/actions/pharmacy";
import { Button } from "@/components/ui/button";

export function DeleteMedicineButton({ medicineId }: { medicineId: string }) {
  const router = useRouter();
  const t = useTranslations("pharmacy.detail");
