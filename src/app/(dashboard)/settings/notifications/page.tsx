...
import { TelegramWebhookButton } from "@/components/notifications/telegram-webhook-button";
...
export default async function NotificationSettingsPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl space-y-6 p-4 sm:p-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">{tg("botSetup")}</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          <p className="text-xs text-[var(--muted-foreground)]">{tg("botSetupHint")}</p>
